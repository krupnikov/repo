...
# 2. доменная часть не короче 3 символов и не длиннее 256, является набором непустых строк, состоящих из символов
# a-z 0-9_- и разделенных точкой; 
...
def checkemailogin(email):
    if re.search(r'', email) is True:
        print('Correct email')
    else:
